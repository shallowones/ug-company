...
<table class="data-table bx-registration-table">
	...
	<tbody>
        <tr>
            ...
            <td>
                <input type="text" id="reg_email" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="bx-auth-input" />
            </td>
        </tr>
		<tr>
...
<?// ******************** /User properties ***************************************************
	...
	<tfoot>
		<tr>
			<td></td>
			<td>
                <input type="submit" name="Register" class="register_start" value="<?=GetMessage("AUTH_REGISTER")?>" />
            </td>
		</tr>
	</tfoot>
</table>
