...
class StatusChangedToCompleteSpecification extends SpecificationUnit
{
    protected $name = 'Статус изменен на "Услуга оказана"';

    public function isSatisfiedBy(IEntity $entity, Event $event)
    {
        return ((new RequestFacade())->getStatusComplete()['ID'] == $event->getData()['newStatus']);
    }
