...
/**
 * Реализует алгоритм подстановки строкового значения "новой" даты установки статуса заявления
 *
 * Class NewDateStatusFormatter
 * @package UW\Modules\Notify\Formatters\Requests
 */
class NewDateStatusFormatter implements IStrategy, IStrategyInforming
{
    /**
    ...
    private $variableInfo = [
        '#newDateStatus' => 'Новая дата установки статуса заявления'
    ];
    ...
    public function algorithm(array $dataFormatting, IEntity $entity, Event $event)
    {
        ...
        $replacer = new Replacer('#newDateStatus', $newDate);
