...
/**
 * Реализует алгоритм подстановки строкового значения "нового" типа сообщения заявления
 *
 * Class NewTypeMessageFormatter
 * @package UW\Modules\Notify\Formatters\Requests
 */
class NewTypeMessageFormatter implements IStrategy, IStrategyInforming
{
    /**
    ...
    private $variableInfo = [
        '#newTypeMessage' => 'Новый тип сообщения'
    ];
    ...
    {
        $replacer = new Replacer('#newTypeMessage', $event->getData()['newMessageType']);
