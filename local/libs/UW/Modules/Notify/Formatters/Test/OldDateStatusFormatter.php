...
/**
 * Реализует алгоритм подстановки строкового значения "старой" даты установки статуса заявления
 *
 * Class OldDateStatusFormatter
 * @package UW\Modules\Notify\Formatters\Requests
 */
class OldDateStatusFormatter implements IStrategy, IStrategyInforming
{
    /**
    ...
    private $variableInfo = [
        '#oldDateStatus' => 'Старая дата установки статуса заявления'
    ];
    ...
    public function algorithm(array $dataFormatting, IEntity $entity, Event $event)
    {
        ...
        $replacer = new Replacer('#oldDateStatus', $oldDate);
