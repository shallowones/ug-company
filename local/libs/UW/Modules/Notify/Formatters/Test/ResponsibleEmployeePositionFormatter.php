...
/**
 * Реализует алгоритм подстановки должности ответственного сотрудника
 *
 * Class ResponsibleEmployeePositionFormatter
 * @package UW\Modules\Notify\Formatters\Requests
 */
class ResponsibleEmployeePositionFormatter implements IStrategy, IStrategyInforming
{
    ...
    protected $variableInfo = [
        '#responsibleEmployeePosition' => 'Должность ответственного сотрудника'
    ];
    ...
    public function algorithm(array $dataFormatting, IEntity $entity, Event $event)
    {
        ...
        $replacer = new Replacer('#responsibleEmployeePosition', $userData['WORK_POSITION']);
