...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"GROUPS_FOR_SELECT_LIST" => array(0=>"INDIVIDUALS",1=>"ENTREPRENEUR",2=>"ORGANIZATION",3=>"",),
		...
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("list"=>"","detail"=>"#ELEMENT_ID#/","add"=>"add/","edit"=>"#ELEMENT_ID#/edit/","status"=>"#ELEMENT_ID#/status/","drafts"=>"drafts/",),
